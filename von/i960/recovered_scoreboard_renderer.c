...
struct recovered_scoreboard_plan {
    ...
    struct recovered_scoreboard_digit_plan background;
                               ...
                               struct recovered_scoreboard_plan *plan)
{
    ...
    plan->background = (struct recovered_scoreboard_digit_plan){
        0x02fe14feU, 0x1dc10U, 15U, 18U, 31U, 2U, 0U
    };

    recovered_scoreboard_digit(&plan->first_tens, 25U, 21U,
                               (first_low / 10U) & 15U, 0x1dc90U);
