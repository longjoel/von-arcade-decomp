/* Selector-2 post-dispatch helper selection recovered from i960 0x8af20-0x8af94. */
...
} recovered_startup_mode4_arm_8af20_float_selection_result;

recovered_startup_mode4_arm_8af20_float_selection_result
recovered_startup_mode4_arm_8af20_float_selection(
    recovered_u32 state_51c950, recovered_u32 state_51c954,
    recovered_u32 helper_result, recovered_u32 timing_5770f0)
{
    recovered_startup_mode4_arm_8af20_float_selection_result result;
    ...
    result.continuation = 0x0008af94U;
    return result;
}
