/* Paired alternate packed-record initializer recovered from i960 0xebe20-ebf04. */
...
typedef struct {
    ...
    recovered_u32 match_slot_address[4], normalized_match_value;
    recovered_u32 status_counter_before, status_counter_after;
    recovered_u32 status_counter_address, return_target;
} recovered_runtime_alt_record_table_init_result_ebe20;

recovered_runtime_alt_record_table_init_result_ebe20
recovered_runtime_alt_record_table_init_ebe20(
    recovered_u32 caller_target, recovered_u32 status_counter_before)
{
    recovered_runtime_alt_record_table_init_result_ebe20 result;
    recovered_u32 i;
    result.workspace_base = 0x01080000U;
    result.packed_byte_count = 0x00080000U;
    ...
    result.scanner_address = 0x000ebd20U;
    result.match_slot_address[0] = 0x00578578U;
    result.match_slot_address[1] = 0x0057857cU;
    result.match_slot_address[2] = 0x00578580U;
    result.match_slot_address[3] = 0x00578584U;
    ...
    result.return_target = 0x000ebf04U;
    return result;
}
