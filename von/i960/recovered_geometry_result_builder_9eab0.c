/* Geometry-result builder recovered from i960 0x9eab0-0x9ecd8. */
#include <stdint.h>

typedef uint32_t u32;

struct recovered_geometry_result_builder_9eab0_plan {
    u32 selector;
    ...
    u32 flag_offset;
    u32 initial_default_value;
    u32 initial_default_output_offset;
    u32 initial_default_paired_offset;
...
void recovered_geometry_result_builder_9eab0_plan(
    u32 selector, u32 object_flag_a0,
    struct recovered_geometry_result_builder_9eab0_plan *plan)
{
    ...
    plan->initial_default_value = 0xffffe000U;
    plan->initial_default_output_offset = 0x0cU;
    plan->initial_default_paired_offset = 0x06U;
    ...
    /* The sibling's NOTBIT 31 toggles only the IEEE sign bit. */
...
/* The flagged arm has the same command-10 operand order as 0x9e880. */
void recovered_geometry_result_builder_9eab0_flag_set_packet(
