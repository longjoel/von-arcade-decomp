/* Subtract-0x14a indexed table packet callsite from i960 0x924ac-0x925dc. */
#include "recovered_common.h"

struct recovered_geometry_table_packet_callsite_924ac_plan {
...
void recovered_geometry_table_packet_callsite_924ac(
    recovered_u32 source_value, recovered_u32 frame_word,
    recovered_u32 frame_readback, const recovered_u32 response_word[3],
    struct recovered_geometry_table_packet_callsite_924ac_plan *plan)
{
    recovered_u32 adjusted = source_value - 0x14aU;
