/* Strided alternate packed-record initializer recovered from i960 0xec140-ec1dc. */
...
} recovered_runtime_alt_record_table_init_result_ec140;

recovered_runtime_alt_record_table_init_result_ec140
recovered_runtime_alt_record_table_init_ec140(
    recovered_u32 caller_target, recovered_u32 status_counter_before)
{
    recovered_runtime_alt_record_table_init_result_ec140 result;
    recovered_u32 i;
    result.workspace_base = 0x01810000U;
    ...
    result.scanner_address = 0x000ec090U;
    result.match_slot_address = 0x00578590U;
    ...
    result.return_target = 0x000ec1dcU;
    return result;
}
