/* Selector-1 packet/state tail recovered from i960 0x8ad00-0x8aecc. */
#include "recovered_common.h"

typedef struct {
    recovered_u32 command_31_first_word;
    recovered_u32 command_31_word_1;
    recovered_u32 command_31_word_2;
    recovered_u32 command_31_word_3;
    recovered_u32 command_31_word_4;
...
} recovered_startup_mode4_arm_8ad00_packet_state_tail_result;

recovered_startup_mode4_arm_8ad00_packet_state_tail_result
recovered_startup_mode4_arm_8ad00_packet_state_tail(
    recovered_u32 command_31_first_word, recovered_u32 command_31_word_1,
    recovered_u32 command_31_word_2, recovered_u32 command_31_word_3,
    recovered_u32 command_31_word_4, recovered_u32 first_command_10_word_1,
...
{
    recovered_startup_mode4_arm_8ad00_packet_state_tail_result result;

    result.command_31_first_word = command_31_first_word;
    result.command_31_word_1 = command_31_word_1;
    result.command_31_word_2 = command_31_word_2;
    result.command_31_word_3 = command_31_word_3;
    result.command_31_word_4 = command_31_word_4;
