/* Second flagged geometry state packet recovered from i960 0x9d730-0x9d858. */
#include <stdint.h>
#include "recovered_common.h"

typedef uint32_t u32;

struct recovered_geometry_second_flagged_state_packet_plan {
    u32 flag_bit1;
    int16_t state_word;
...
void recovered_geometry_second_flagged_state_packet_plan(
    u32 object_flag_1dd, int16_t state_word, u32 derived_packet_word,
    u32 frame_value, u32 board_readback_address,
    struct recovered_geometry_second_flagged_state_packet_plan *plan)
{
    plan->flag_bit1 = (object_flag_1dd >> 1) & 1U;
