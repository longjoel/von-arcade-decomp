/* Selector-1 helper selection recovered from i960 0x8baf0-0x8bb60. */
...
} recovered_startup_mode4_arm_8baf0_float_selection_result;

recovered_startup_mode4_arm_8baf0_float_selection_result
recovered_startup_mode4_arm_8baf0_float_selection(
    recovered_u32 timing_5770f0, recovered_u32 helper_result)
{
    recovered_startup_mode4_arm_8baf0_float_selection_result result;
    ...
    result.low_timing_path = result.adjusted_timing < 1U ? 1U : 0U;
    ...
    result.continuation = 0x0008bb60U;
    return result;
}
