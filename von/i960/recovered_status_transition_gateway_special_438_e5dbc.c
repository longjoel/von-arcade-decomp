/* Exact-0x438 gateway arm recovered from i960 0xe5dbc-0xe5de8. */
...
} recovered_status_transition_gateway_special_438_result_e5dbc;

void recovered_status_transition_gateway_special_438_e5dbc(
    recovered_status_transition_gateway_special_438_result_e5dbc *result)
{
    ...
    result->continuation = 0x000e60d0U;
}
