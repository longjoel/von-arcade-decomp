/* Selector-1 downstream packet/state prefix recovered from i960 0x89e44-0x89f34. */
...
} recovered_startup_mode4_arm_89e44_packet_state_prefix_result;

recovered_startup_mode4_arm_89e44_packet_state_prefix_result
recovered_startup_mode4_arm_89e44_packet_state_prefix(
    ...
    recovered_u32 second_fifo_response)
{
    recovered_startup_mode4_arm_89e44_packet_state_prefix_result result;
    ...
    result.continuation = 0x00089f34U;
    return result;
}
