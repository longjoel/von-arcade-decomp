/* Response-helper gate-1 state bridge recovered from i960 0x8cd30-0x8ce14. */
...
} recovered_startup_mode4_arm_8cd30_response_state_bridge_result;

recovered_startup_mode4_arm_8cd30_response_state_bridge_result
recovered_startup_mode4_arm_8cd30_response_state_bridge(
...
{
    recovered_startup_mode4_arm_8cd30_response_state_bridge_result result;
    ...
    result.continuation = 0x0008ce14U;
    return result;
}
