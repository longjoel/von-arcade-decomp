/* Second post-bank packed-record match scan recovered from i960 0xeb9a4-ebaa4. */
...
} recovered_runtime_packed_record_match_scan_b_result_eb9a4;

int
recovered_runtime_packed_record_match_scan_b_eb9a4(
    recovered_u32 packed_byte_count, recovered_u32 target_word,
    const recovered_u32 *scan_words, recovered_u32 scan_word_capacity,
    recovered_runtime_packed_record_match_scan_b_result_eb9a4 *result)
{
    recovered_runtime_packed_record_match_scan_b_result_eb9a4 local;
    recovered_u32 i;
    ...
    local.workspace_base = 0x00910004U;
    ...
    local.return_target = 0x000ebaa4U;
    if (result != (recovered_runtime_packed_record_match_scan_b_result_eb9a4 *)0)
        *result = local;
