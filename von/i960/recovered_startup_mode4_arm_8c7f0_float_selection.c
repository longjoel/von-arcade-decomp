/* Selector-3 helper selection recovered from i960 0x8c7f0-0x8c840. */
...
typedef struct {
    ...
    recovered_u32 first_adjusted_float;
...
} recovered_startup_mode4_arm_8c7f0_float_selection_result;

recovered_startup_mode4_arm_8c7f0_float_selection_result
recovered_startup_mode4_arm_8c7f0_float_selection(
    recovered_u32 timing_5770f0, recovered_u32 helper_result)
{
    recovered_startup_mode4_arm_8c7f0_float_selection_result result;
    ...
    result.first_adjusted_float = selected.bits;
    if (timing_5770f0 == 0U) {
        selected.value += 2.5F;
        result.first_adjusted_float = selected.bits;
    }
    result.adjusted_float = result.first_adjusted_float;
    if (timing_5770f0 == 0U) {
        selected.bits = result.adjusted_float;
        selected.value += 2.5F;
    ...
    result.continuation = 0x0008c840U;
    return result;
}
