/* Published paired-row accessor recovered from i960 0x88310-0x88374. */
#include <stdint.h>

typedef uint32_t u32;

struct recovered_stage_paired_published_row_accessor_88310 {
    int32_t state_value;
    u32 timing_index;
...
struct recovered_stage_paired_published_row_accessor_88310
recovered_stage_paired_published_row_accessor_88310(int32_t state_value,
                                                     u32 timing_index,
                                                     u32 first_table_value,
                                                     u32 second_table_value)
{
    struct recovered_stage_paired_published_row_accessor_88310 out;

    out.state_value = state_value;
    out.timing_index = timing_index;
    out.return_trampoline_load_address = 0x00088310U;
    out.return_trampoline_target = 0x00088374U;
