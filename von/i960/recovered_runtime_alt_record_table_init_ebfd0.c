/* Third alternate packed-record initializer recovered from i960 0xebfd0-ec084. */
...
typedef struct {
    ...
    recovered_u32 match_slot_address[2], normalized_match_value;
    recovered_u32 status_counter_before, status_counter_after;
    recovered_u32 status_counter_address, return_target;
} recovered_runtime_alt_record_table_init_result_ebfd0;

recovered_runtime_alt_record_table_init_result_ebfd0
recovered_runtime_alt_record_table_init_ebfd0(
    recovered_u32 caller_target, recovered_u32 status_counter_before)
{
    recovered_runtime_alt_record_table_init_result_ebfd0 result;
    recovered_u32 i;
    result.workspace_base = 0x01800000U;
    ...
    result.scanner_address = 0x000ebf10U;
    result.match_slot_address[0] = 0x00578588U;
    result.match_slot_address[1] = 0x0057858cU;
    ...
    result.return_target = 0x000ec084U;
    return result;
}
