/* Exact dispatch prefix recovered from i960 0x7c470-0x7c4a8. */
#include <stdint.h>

typedef uint32_t u32;

enum recovered_transition_route_7c470_kind {
    RECOVERED_TRANSITION_7C470_TIMING = 0,
    RECOVERED_TRANSITION_7C470_PACKET = 1,
};

struct recovered_transition_route_7c470_plan {
    u32 route;
...
void recovered_transition_route_7c470(
    u32 selector_504e20, u32 object_state,
    struct recovered_transition_route_7c470_plan *plan)
{
    plan->route = RECOVERED_TRANSITION_7C470_PACKET;
    plan->calls_timing_variant = 0U;
    plan->timing_target = 0U;
    plan->packet_target = 0x0007c4a8U;
    ...
    if (selector_504e20 == 0xffffffffU) {
        plan->route = RECOVERED_TRANSITION_7C470_TIMING;
