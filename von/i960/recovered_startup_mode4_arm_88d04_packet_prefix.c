/* First 0x88cec dispatch arm packet prefix recovered from i960 0x88d04-0x88d70. */
...
} recovered_startup_mode4_arm_88d04_packet_prefix_result;

recovered_startup_mode4_arm_88d04_packet_prefix_result
recovered_startup_mode4_arm_88d04_packet_prefix(
    recovered_u32 record_184, recovered_u32 fifo_response,
    recovered_u32 record_8)
{
    recovered_startup_mode4_arm_88d04_packet_prefix_result result;
    ...
    result.continuation = 0x00088d70U;
    return result;
}
