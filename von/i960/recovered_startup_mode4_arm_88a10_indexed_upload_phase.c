/* Indexed upload phase of helper 0x88a10 recovered from i960 0x88a10-0x88a64. */
...
} recovered_startup_mode4_arm_result_88a10_indexed_upload_phase;

int recovered_startup_mode4_arm_88a10_indexed_upload_phase(
    recovered_u32 timing_input,
    recovered_startup_mode4_arm_result_88a10_indexed_upload_phase *result)
{
    recovered_startup_mode4_arm_result_88a10_indexed_upload_phase r = {0};
