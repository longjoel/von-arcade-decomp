/* Selector-2 packet/state prefix recovered from i960 0x8bd74-0x8be00. */
...
} recovered_startup_mode4_arm_8bd74_packet_state_prefix_result;

recovered_startup_mode4_arm_8bd74_packet_state_prefix_result
recovered_startup_mode4_arm_8bd74_packet_state_prefix(
    recovered_u32 first_response, recovered_u32 second_response,
    recovered_u32 current_record_8, recovered_u32 current_record_10)
{
    recovered_startup_mode4_arm_8bd74_packet_state_prefix_result result;

    result.first_response = first_response;
    result.transformed_base = first_response + 0x5000U;
    ...
    result.continuation = 0x0008be00U;
    return result;
}
