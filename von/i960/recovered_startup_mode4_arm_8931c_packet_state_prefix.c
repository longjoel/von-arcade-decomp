/* Selector-3 packet/state prefix recovered from i960 0x8931c-0x89450. */
...
typedef struct {
    ...
    recovered_u32 stored_record_184_minus_6000;
    recovered_u32 packet_record_184_minus_6000_low16;
...
} recovered_startup_mode4_arm_8931c_packet_state_prefix_result;

recovered_startup_mode4_arm_8931c_packet_state_prefix_result
recovered_startup_mode4_arm_8931c_packet_state_prefix(
...
{
    recovered_startup_mode4_arm_8931c_packet_state_prefix_result result;
    ...
    result.stored_record_184_minus_6000 = record_184 - 0x6000U;
    result.packet_record_184_minus_6000_low16 =
        result.stored_record_184_minus_6000 & 0xffffU;
    ...
    result.packet_29[1] = result.packet_record_184_minus_6000_low16;
    result.packet_29[2] = 0x42a00000U;
    result.packet_30[0] = 30U;
    result.packet_30[1] = result.packet_record_184_minus_6000_low16;
    ...
    result.state_51c940 = result.stored_record_184_minus_6000;
    ...
    result.continuation = 0x00089450U;
    return result;
}
