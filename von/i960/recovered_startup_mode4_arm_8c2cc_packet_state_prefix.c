/* Selector-1 packet/state prefix recovered from i960 0x8c2cc-0x8c358. */
...
} recovered_startup_mode4_arm_8c2cc_packet_state_prefix_result;

recovered_startup_mode4_arm_8c2cc_packet_state_prefix_result
recovered_startup_mode4_arm_8c2cc_packet_state_prefix(
    recovered_u32 first_response, recovered_u32 second_response,
    recovered_u32 current_record_8, recovered_u32 current_record_10)
{
    recovered_startup_mode4_arm_8c2cc_packet_state_prefix_result result;
    ...
    result.continuation = 0x0008c358U;
    return result;
}
