-- Probe opcode 0x42 with all three signed-16 angle fields enabled.
...
emu.register_periodic(function()
    ...
    if not space then
        ...
        if cpu then
            ...
            log_file = assert(io.open(os.getenv("VON_SHARC_42_COMBINED_LOG") or
                "vonj-sharc-opcode-42-combined.log", "w"))
