...
class Input(ctypes.Structure):
    _fields_ = [(name, ctypes.c_uint32) for name in (
        "record_word", "record_word4", "record_halfword6", "source_table_word", "coordinate_2",
...
with tempfile.TemporaryDirectory() as directory:
    ...
    sample = Input(0x11223344, 0x55667788, 0x8004, 0x12345678,
                   0xaaaa0002, 0xbbbb0001, 0xcccc0003, 0xdddd0004,
                   0xeeee0005, 0xeeee0005, 0x1234abcd)
    plan = Plan()
    ...
    assert list(plan.window_word) == [0x11223344, 0x55667788, 0xffff8004, 0]
