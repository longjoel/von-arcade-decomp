#!/usr/bin/env python3
"""Validate the secondary response-25 compare wrapper."""
import ctypes
import pathlib
import subprocess
import tempfile
...
SOURCE = ROOT / "von/i960/recovered_startup_mode4_arm_87720_secondary_compare_25.c"
...
def main():
    with tempfile.TemporaryDirectory() as directory:
        ...
        fn = ctypes.CDLL(str(library)).recovered_startup_mode4_arm_87720_secondary_compare_25
        fn.argtypes = [ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(Result)]
        fn.restype = ctypes.c_int
        for predicate, expected in ((0, 0x878a0), (1, 0x878e8), (7, 0x878e8)):
            result = Result()
    ...
    print("PASS: 0x87720 secondary response-25 compare")
