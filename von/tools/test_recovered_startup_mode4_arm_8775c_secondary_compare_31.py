#!/usr/bin/env python3
"""Validate the secondary response-31 compare wrapper."""
import ctypes
import pathlib
import subprocess
import tempfile
...
SOURCE = ROOT / "von/i960/recovered_startup_mode4_arm_8775c_secondary_compare_31.c"
...
def main():
    with tempfile.TemporaryDirectory() as directory:
        ...
        fn = ctypes.CDLL(str(library)).recovered_startup_mode4_arm_8775c_secondary_compare_31
    ...
    print("PASS: 0x8775c secondary response-31 compare")
