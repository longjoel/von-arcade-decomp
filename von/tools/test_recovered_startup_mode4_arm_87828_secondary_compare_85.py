#!/usr/bin/env python3
"""Validate the secondary response-85 compare wrapper."""
import ctypes
import pathlib
import subprocess
import tempfile
...
SOURCE = ROOT / "von/i960/recovered_startup_mode4_arm_87828_secondary_compare_85.c"
...
def main():
    with tempfile.TemporaryDirectory() as directory:
        ...
        fn = ctypes.CDLL(str(library)).recovered_startup_mode4_arm_87828_secondary_compare_85
    ...
    print("PASS: 0x87828 secondary response-85 compare")
