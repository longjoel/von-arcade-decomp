#!/usr/bin/env python3
"""Validate the secondary response-a9 compare wrapper."""
import ctypes
import pathlib
import subprocess
import tempfile
...
SOURCE = ROOT / "von/i960/recovered_startup_mode4_arm_87888_secondary_compare_a9.c"
...
def main():
    with tempfile.TemporaryDirectory() as directory:
        ...
        fn = ctypes.CDLL(str(library)).recovered_startup_mode4_arm_87888_secondary_compare_a9
    ...
    print("PASS: 0x87888 secondary response-a9 compare")
