#!/usr/bin/env python3
"""Validate primary response-7f/85/a9 compare wrappers."""
import ctypes
import pathlib
import subprocess
import tempfile
...
SOURCE = ROOT / "von/i960/recovered_startup_mode4_arm_primary_compare_7f_85_a9.c"
...
def main():
    with tempfile.TemporaryDirectory() as directory:
        ...
        fn = ctypes.CDLL(str(library)).recovered_startup_mode4_arm_primary_compare_7f_85_a9
    ...
    print("PASS: primary response-7f/85/a9 compare")
