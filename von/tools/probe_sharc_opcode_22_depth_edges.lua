-- Exercise opcode 0x22 with zero, negative, and NaN affine depth.
local frame = 0
local space
local log_file
...
local cases = {
    { "zero-depth", 0x3f800000, 0x40000000, 0x00000000, 0x00000000 },
    { "negative-depth", 0x3f800000, 0x40000000, 0xc0400000, 0x00000000 },
    { "nan-depth", 0x3f800000, 0x40000000, 0xffffffff, 0x00000000 },
}
...
emu.register_periodic(function()
    ...
    if not space then
        ...
        if cpu then
            ...
            log_file = assert(io.open(os.getenv("VON_SHARC_22_DEPTH_LOG") or
                "von-sharc-opcode-22-depth-edges.log", "w"))
            log("probe: start")
        end
    end
