-- Seed an asymmetric matrix, then exercise opcode 0x33's R14/R13 passes.
...
emu.register_periodic(function()
    ...
    if not space then
        ...
        if cpu then
            ...
            log_file = assert(io.open(os.getenv("VON_SHARC_33_ASYMMETRIC_LOG") or
                "vonj-sharc-opcode-33-asymmetric.log", "w"))
    ...
    elseif frame == 780 then
        ...
        log_file:write("probe: R14=R13=0x4000\n"); log_file:flush()
