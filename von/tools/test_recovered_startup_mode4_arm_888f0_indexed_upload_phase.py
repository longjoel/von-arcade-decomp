#!/usr/bin/env python3
"""Validate the exact indexed-upload phase of helper 0x888f0."""
import ctypes
import pathlib
import subprocess
import tempfile
...
SOURCE = ROOT / "von/i960/recovered_startup_mode4_arm_888f0_indexed_upload_phase.c"
...
def main():
    with tempfile.TemporaryDirectory() as directory:
        ...
        fn = ctypes.CDLL(str(library)).recovered_startup_mode4_arm_888f0_indexed_upload_phase
    ...
    print("PASS: 0x888f0 indexed upload phase")
