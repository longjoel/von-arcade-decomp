#!/usr/bin/env python3
"""Validate the secondary response-7f compare wrapper."""
import ctypes
import pathlib
import subprocess
import tempfile
...
SOURCE = ROOT / "von/i960/recovered_startup_mode4_arm_8780c_secondary_compare_7f.c"
...
def main():
    with tempfile.TemporaryDirectory() as directory:
        ...
        fn = ctypes.CDLL(str(library)).recovered_startup_mode4_arm_8780c_secondary_compare_7f
    ...
    print("PASS: 0x8780c secondary response-7f compare")
